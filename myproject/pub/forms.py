...
class ContactForm(forms.Form):
	DecorationNote = forms.CharField(initial='Here you can write your comment!', widget=forms.Textarea(attrs={'class':'notebox'}))
	TortNote = forms.CharField(initial='Here you can write your comment!', widget=forms.Textarea(attrs={'class':'notebox'}))
